      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
         <img style={{height: '80px', width:'150px', paddingTop:'10px'}}src={brandsenselogo} />
          ...
          <Button
                onClick={handleCloseNavMenu}><a href="/InfluencerPendingCampaigns" style={{ my: 2, color: 'black', display: 'block', textTransform:"capitalize" }}>Pending Requests</a></Button>
          <Button
                onClick={handleCloseNavMenu}><a href="/InfluencerContent" style={{ my: 2, color: 'black', display: 'block', textTransform:"capitalize" }}>Content</a></Button>
          {/* <Button
